...
const FormBuilder = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex px-8 py-12 gap-8">
      {/* Left: Field Creator */}
      <div className="w-full md:w-1/2 bg-white rounded-2xl shadow-xl p-8 flex flex-col">
        ...
        <h3 className="text-lg font-medium text-gray-700 mb-3">Fields List</h3>
      ...
      <div className="w-full md:w-1/2 bg-white rounded-2xl shadow-xl p-8 flex flex-col border-l border-gray-200">
